...
import { clickAtCreateButton, clickAtCreateNewActivity, clickAtDeleteButton, clickAtDeleteTestingActivityModalButton, fillActivitiesForm, goToActivitiesPage } from "../pages/Activities-pages";
